  ...
  return (
    ...
    <div className='row mt-5 mb-5'>
     <div className='col-md-6'>
        <h1 className='lefttitle'>The Local Tasker Vision</h1>
        <p className='mt-4 ourstorypara'>At Local Tasker, we ve made it simple to connect those
...
<p className='mt-4 ourstorypara'>But we re about more than just connections. At the heart
...
difference and be part of our exciting journey.
     ...
     <div className='rect2'>
     <Image src='/vision.png' alt="rightbox" className='vhgimage' width={500} height={400}/>
     </div>
     </div> 
    </div>
    </div>
