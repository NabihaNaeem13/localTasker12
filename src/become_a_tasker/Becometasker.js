...
const Becometasker = () => {
  return (
    <>
    <Becometopbox title="Flexible work" subtitle="opportunities that are" para="Find local jobs that fit your skills and schedule! Be
...
start their own businesses." btnvalue="Get Started" img="/makemoneyyourway.png" link='https://localtasker.thedatech.com/register?type=1'/>
</div>
    <MobileCardLeft/>
