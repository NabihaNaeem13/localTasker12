...
export const MainContent = () => {
  ...
  return (
    ...
    <div className='row'>
       ...
       <div className='col-8'>
            <h1 className='answertitle'>{sections[activeSection]}</h1>
...
<h6 className='mt-3 mb-3 mx-3' style={{color:"gray",fontWeight:"800"}}>A few highlights of these Terms of Service include:</h6>
<ul style={{listStyle:"inside",color:"#959393",fontSize: '14px'}}>
...
<button className='hirebtn'>Read More</button>
      ...
      <div className='row px-1'>
        <h1 className='answertitle text-center'>Privacy Policy</h1>
         <h2 className='answertitle'>1. Introduction</h2>
...
the terms and conditions in the Agreement for that country.</p>
<h6 className='mt-3 mb-3 mx-3' style={{color:"gray",fontWeight:"800"}}>A few highlights of these Terms of Service include:</h6>
<ul style={{listStyle:"inside",fontSize:"12px",color: "#959393"}}>
    <li>You must be at least the legally required age in the jurisdiction in which
you reside and otherwise capable of entering into binding contracts, in order
to use or access the Local Tasker Platform (Section 2).</li>
<li>Your agreement that the technology for the Local Tasker Platform is
...
<h2 className='answertitle'>2. The Local Tasker Platform
Connects Taskers and Clients</h2>
